...
# example, see https://github.com/cucumber/cucumber/wiki/Cucumber-Backgrounder
# product should belong to a category
When /^I( dont)? test (.*)$/ do |boolean, product|
  message = "Product '#{product}' should#{boolean} belong to a category"
  actual = true
  expected = !boolean
