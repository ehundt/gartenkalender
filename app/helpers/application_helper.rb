module ApplicationHelper
  ...
  def help_content
    ...
    content += '</td><td>Zum Veröffentlichen dieser Pflanzenbeschreibung auf dieses Icon klicken.'
    content += '</td></tr><tr><td>'
    content += image_tag "plant_active.gif", height: "42px", width: "30px"
    content += '</td><td>Pflanze aktiv bzw. inaktiv schalten durch Klick auf die Pflanze. Nur die Pflegetipps für aktive Pflanzen werden in der Aufgabenliste angezeigt.'
    content += '</td></tr><tr><td>'
